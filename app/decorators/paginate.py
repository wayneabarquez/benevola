...
def paginate(collection, max_per_page=25):
    ...
    def decorator(f):
        ...
        def wrapped(*args, **kwargs):
            ...
            if p.has_next:
                pages['next_page'] = p.next_num
                pages['next_url'] = url_for(request.endpoint, page=p.next_num,
                                            per_page=per_page, external=True,
                                            **kwargs)
            else:
